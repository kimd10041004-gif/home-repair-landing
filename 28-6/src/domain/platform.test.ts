...
describe('월별 리포트 (28-5-03)', () => {
  it('월별 건수/금액/정산 구분을 집계하고 최신 월부터 정렬한다', () => {
    ...
    const aug = make('2026-08-25', 0) // total 275,000 / payout 261,250
    make('2026-09-02', 150_000) // total 110,000 / fee 5,500 / payout 104,500
    p.settle(aug.id)
    ...
    expect(sep.payout).toBe(104_500)
    expect(sep.unsettledPayout).toBe(104_500)
    expect(sep.settledPayout).toBe(0)
    const augRow = report[1]!
    expect(augRow.settledPayout).toBe(261_250)
