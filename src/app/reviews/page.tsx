...
export const metadata: Metadata = {
  title: "작업사례",
  description:
    "생활 집수리, 세입자·주거 케어, 스마트홈 IoT 케어별 작업사례를 실제 사례 여부와 함께 소개합니다.",
...
export default function ReviewsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <h1 className="text-xl font-bold text-brand-navy sm:text-2xl">작업사례</h1>
      <p className="mt-2 text-sm text-slate-600">
        서비스별 작업 사례를 실제 사례 여부와 함께 투명하게 안내합니다.
      </p>
