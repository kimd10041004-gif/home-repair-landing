...
test('formatDateKo: 달력에 없는 날짜는 롤오버하지 않고 거부 (28-1-04)', () => {
  assert.throws(() => formatDateKo('2026-02-31'), TypeError)
  assert.throws(() => formatDateKo('2026-13-01'), TypeError)
  // 윤년은 허용
  assert.equal(formatDateKo('2024-02-29'), '2024년 2월 29일 (목)')
})
