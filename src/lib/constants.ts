...
export const TENANT_CARE = {
  ...
  heroHighlights: [
    "서울·경기 기본권역 총 예상 결제금액 240,000원부터",
    "경기 외곽권역 총 예상 결제금액 270,000원부터",
    "자재비 별도",
    "모든 표시 금액은 부가가치세 포함",
...
export const TENANT_CARE_PACKAGES: TenantCarePackage[] = [
  {
    ...
    targetNote: "소형 작업 중심",
    priceBaseWon: 240000,
    priceOuterWon: 270000,
    laborIncludedWon: 190000,
    includes: [
      "패키지 기본 공임 190,000원 포함",
      "해당 권역 출장비 포함",
      "자재비 별도",
      "부가가치세 포함",
      "1인 작업자 본 시공 1회 기준",
  ...
  },
  {
    ...
    priceBaseWon: 540000,
    priceOuterWon: 570000,
    laborIncludedWon: 490000,
    includes: [
      "패키지 기본 공임 490,000원 포함",
      "해당 권역 출장비 포함",
      "자재비 별도",
      "부가가치세 포함",
      "1인 작업자 본 시공 1회 기준",
  ...
  },
  {
    ...
    priceBaseWon: 940000,
    priceOuterWon: 970000,
    laborIncludedWon: 890000,
    includes: [
      "패키지 기본 공임 890,000원 포함",
      "해당 권역 출장비 포함",
      "자재비 별도",
      "부가가치세 포함",
      "필요 시 현장 실측 1회",
