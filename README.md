...
기존 맥 데스크탑의 "반듯 집수리 클로드 27 ver." 라운드 루프를 GitHub 저장소 기반으로 이어가는 신규 시리즈. **이 앱은 파트너 1인용 도구다(단일 파트너 스코프, 28-5-05 결정)** — 도메인의 partnerId 분리는 백업 이관·향후 관리자 앱을 위해 유지하며, 다중 파트너 계정/권한 관리는 별도 관리자 앱의 범위로 둔다. 데스크탑 원본 폴더는 건드리지 않으며, 방법론(라운드 스냅샷·감사·수정·검증·해시 무결성)은 동일하게 유지한다.
