...
export async function POST(req: NextRequest) {
  ...
  const { allowed, retryAfterSeconds } = checkRateLimit(`tenant-care:${ip}`, 5, 60_000);
  if (!allowed) {
